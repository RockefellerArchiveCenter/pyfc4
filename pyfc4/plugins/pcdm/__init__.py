...
def create_pcdm_demo_resources(repo):
	...
	ravenpage1text.create(specify_uri=True)
	...
	ravenpage2text.create(specify_uri=True)
	...
	ravenpage2proxy.create(specify_uri=True)
